...
export const LAB_REPORT_ROUTES: Routes = [
  { path: 'lab-reports', loadComponent: () => import('./pages/lab-report-list-page.component').then((m) => m.LabReportListPageComponent), data: { title: 'Lab Reports' } },
  {
    ...
    loadComponent: () => import('./pages/lab-report-upload-page.component').then((m) => m.LabReportUploadPageComponent),
  ...
  {
    path: 'lab-reports/:id',
    loadComponent: () => import('./pages/lab-report-detail-page.component').then((m) => m.LabReportDetailPageComponent),
    canDeactivate: [unsavedChangesGuard],
