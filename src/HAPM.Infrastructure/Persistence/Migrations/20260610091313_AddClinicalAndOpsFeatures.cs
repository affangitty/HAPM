...
{
    /// <inheritdoc />
    public partial class AddClinicalAndOpsFeatures : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RespiratoryRatePerMin = table.Column<int>(type: "integer", nullable: true),
                    SystolicBpMmHg = table.Column<int>(type: "integer", nullable: true),
                    DiastolicBpMmHg = table.Column<int>(type: "integer", nullable: true),
                    OxygenSaturationPercent = table.Column<decimal>(type: "numeric(4,1)", precision: 4, scale: 1, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WaitlistEntries_Doctors_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "Doctors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
